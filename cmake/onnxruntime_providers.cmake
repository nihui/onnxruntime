...
if (onnxruntime_USE_CUDA)
  ...
  if (MSVC)
    target_compile_options(onnxruntime_providers_cuda PRIVATE "$<$<COMPILE_LANGUAGE:CUDA>:SHELL:--compiler-options /utf-8>"
...
if (onnxruntime_USE_NGRAPH)
  ...
  if (NOT MSVC)
    target_compile_options(onnxruntime_providers_ngraph PRIVATE "SHELL:-Wformat" "SHELL:-Wformat-security" "SHELL:-fstack-protector-strong")
    target_compile_definitions(onnxruntime_providers_ngraph PRIVATE "$<$<NOT:$<CONFIG:DEBUG>>:_FORTIFY_SOURCE=2>")
